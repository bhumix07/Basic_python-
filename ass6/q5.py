...
balance = int(input("take account balance  : "))
withdrawalam = int(input("take withdrawal amount  : "))
pin = input("correct or incorrect : ")

if balance >= withdrawalam:
    if withdrawalam <= 10000:
        if pin == "correct":
