...
A school is organizing a quiz competition.
Only students whose roll numbers are divisible by 3 are selected for the first round.
...
Output:
12 15 18 21 24'''
n1,n2 = map(int,input("Enter two nums: ").split())
